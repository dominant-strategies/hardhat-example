...
tokenArgs = {
	name: 'TestQRC721', // Name of collection
	symbol: 'TQ721', // Collection symbol
	baseURI: 'ipfs://METADATA_CID/', // Base URI for token metadata (make sure to keep the slash at the end)
}
